...
NUITKA_CROSS_MODULE PyObject *impl___main__$$$function__16_complex_call_helper_star_list_star_dict(PyObject **python_pars);
...
static PyObject *impl_lxml$doctestcompare$$$function__30___call__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_1 = impl___main__$$$function__16_complex_call_helper_star_list_star_dict(dir_call_args);
        }
        if (tmp_assign_source_1 == NULL) {
            assert(ERROR_OCCURRED());
...
static PyObject *impl_lxml$doctestcompare$$$function__31_call_super(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Tried code:
    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_1, tmp_dircall_arg2_1, tmp_dircall_arg3_1};
            tmp_return_value = impl___main__$$$function__16_complex_call_helper_star_list_star_dict(dir_call_args);
        }
        if (tmp_return_value == NULL) {
            assert(ERROR_OCCURRED());
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_33 = impl___main__$$$function__15__mro_entries_conversion(dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_assign_source_42 = impl___main__$$$function__15__mro_entries_conversion(dir_call_args);
        }

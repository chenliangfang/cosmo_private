...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_15 = impl___main__$$$function__15__mro_entries_conversion(dir_call_args);
        }
        if (tmp_assign_source_15 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_23 = impl___main__$$$function__15__mro_entries_conversion(dir_call_args);
        }

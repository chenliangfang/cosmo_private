...
NUITKA_CROSS_MODULE PyObject *impl___main__$$$function__20_complex_call_helper_star_dict(PyObject **python_pars);
...
static PyObject *impl_lxml$isoschematron$$$function__2__stylesheet_param_dict(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    tmp_for_loop_1__for_iterator = NULL;
    {
...

        {
            ...
            tmp_assign_source_9 = impl___main__$$$function__20_complex_call_helper_star_dict(dir_call_args);
        }
        if (tmp_assign_source_9 == NULL) {
            assert(ERROR_OCCURRED());
...
static PyObject *impl_lxml$isoschematron$$$function__4___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_11 = impl___main__$$$function__18_complex_call_helper_pos_star_dict(dir_call_args);
        }
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_28 = impl___main__$$$function__15__mro_entries_conversion(dir_call_args);
        }

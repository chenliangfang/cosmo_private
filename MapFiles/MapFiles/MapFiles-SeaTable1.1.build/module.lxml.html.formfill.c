...
// Mark the execution in the "__spec__" value.
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_assign_source_19 = impl___main__$$$function__15__mro_entries_conversion(dir_call_args);
        }
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_assign_source_44 = impl___main__$$$function__15__mro_entries_conversion(dir_call_args);
        }

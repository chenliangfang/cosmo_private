...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "lxml", 29);
...
void checkModuleConstants_lxml(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "lxml", 29);
}
#endif
...
static PyObject *impl_lxml$$$function__1_get_include(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        frame_8aaa384b31d5ccd39eb366668aed6f62->m_frame.f_lineno = 14;
        {
            ...
            tmp_assign_source_3 = CALL_METHOD_WITH_ARGS2(tmp_called_instance_1, mod_consts[3], call_args);
        }
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "lxml";
...
PyObject *modulecode_lxml(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("lxml: Skipping module init, already done.\n");
#endif
    ...
    // Framed code:
    {
        ...
        tmp_assign_source_3 = PyList_New(2);
        {
            ...
            frame_cae40cb3535b6e73a52cb028e6e3d166->m_frame.f_lineno = 1;
            {
                PyObject *hard_module = PyImport_ImportModule("os");
                if (likely(hard_module != NULL)) {
                    tmp_called_instance_1 = PyObject_GetAttr(hard_module, mod_consts[15]);
                } else {
            ...
            frame_cae40cb3535b6e73a52cb028e6e3d166->m_frame.f_lineno = 1;
            tmp_list_element_1 = CALL_METHOD_WITH_ARGS2(tmp_called_instance_1, mod_consts[16], &PyTuple_GET_ITEM(mod_consts[17], 0));

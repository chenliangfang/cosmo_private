...
class MY_GUI():
    ...
    def set_init_window(self):
        ...
        #标签
        self.Base = Label(self.init_window_name, text="Base:", bg = 'PowderBlue',fg="Black").place(x=18, y= 240,  height=30)
        self.TableName = Label(self.init_window_name, text="Table:", bg = 'PowderBlue',fg="Black").place(x=150, y= 240,  height=30)
        self.Data_Column = Label(self.init_window_name, text="Row:",bg = 'PowderBlue', fg="Black").place(x=300, y= 240,  height=30)
        self.File_Name = Label(self.init_window_name, text="Names:",bg = 'PowderBlue', fg="Black").place(x=450, y= 240,  height=30)
        ...
        #文本框
        self.Base_Entry = Entry(self.init_window_name, width=10,  bd = 3)
        ...
        self.File_Name_Entry = Entry(self.init_window_name, width=10,  bd = 3)
        
        self.Base_Entry.place(x=60, y= 240,  height=30)
        self.TableName_Entry.place(x=200, y= 240,  height=30)
        self.Data_Column_Entry.place(x=350, y= 240,  height=30)
        self.File_Name_Entry.place(x=500, y= 240,  height=30)
        
        self.Base_Entry.insert(0,'Base')
        self.TableName_Entry.insert(0,'Table')
        self.Data_Column_Entry.insert(0,'Row')
        self.File_Name_Entry.insert(0,'{{项目简称}}')
    ...
    def get_data_from_setable(self, base_name, Tabelname):
        ...
        #email = 'chenlf@crctrust.com'
        #password = 'cosmo0419'
        server_url = 'http://10.132.122.82/'
        ...
        for file in files:
            if file.endswith('docx'):
                ...
                showinfo(title = "提示",
                            message = "请选择word格式和excel格式的文件！") 
    def mappfile(self):
        if datetime.datetime.today().year > 2022 and atetime.datetime.today().month() > 5:
            showinfo(title = "提示",
